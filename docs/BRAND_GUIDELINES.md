# INSYT. — Brand Guidelines

> Calm intelligence. Premium simplicity. Human warmth.
...
**Name**: INSYT.
**Full wordmark**: `INSYT.` — always uppercase, always with trailing full stop
...
- `INSYT` in `font-black` (weight 900), tracked at `letter-spacing: 0.08em`
...
- Headings: 1.1–1.2 line height (tighter)
- Letter spacing: tight on headings (`-0.01em`), wide only on wordmark
...
- **Dark mode primary**: `#46E4EE` — bright cyan, glows beautifully on dark surfaces
...
- **Warm** — acknowledges the emotional reality of money
...
- Numbers should always be formatted: £1,200/month, not 1200/month
- Percentages rounded to 1 decimal: 18.5%, not 18.53267%
...
4. Never make specific investment recommendations (regulatory risk)
5. Never shame — even if numbers are alarming, describe them factually and empathetically
...
- Thoughtful empty states — not blank screens, but invitations to engage
- Meaningful colour — green means good, red means attention-needed, not decoration
...
4. **Progress**: Celebrate small wins explicitly — £50 towards a goal deserves acknowledgement
5. **Negative cashflow**: Acknowledge, don't panic. "Your outgoings exceed your income this month — let's look at where there's room."

---

## What NOT to do with the brand

- ❌ Never use `INSYT` without the trailing `.`
- ❌ Never use rounded, bubbly, or playful fonts alongside Manrope
- ❌ Never use neon or very saturated accent colours
- ❌ Never use emoji in product copy (toast messages, insights, alerts)
- ❌ Never show unformatted numbers (always £X,XXX)
- ❌ Never use the word "budget" as a pejorative or in shame contexts
- ❌ Never use urgency language ("Act now!", "You're behind!")
- ❌ Never refer to the AI as "the bot" or "our robot"
