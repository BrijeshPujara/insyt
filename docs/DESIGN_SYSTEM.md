...
```css
--glow-primary: rgb(0 104 116 / 0.18) --glow-emerald: rgb(52 211 153 / 0.14)
  --glow-amber: rgb(251 191 36 / 0.14) --glow-red: rgb(248 113 113 / 0.14);
```
...
background: linear-gradient(
  135deg,
  rgb(var(--surface-container-low) / 0.7),
  rgb(var(--surface) / 0.5)
);
